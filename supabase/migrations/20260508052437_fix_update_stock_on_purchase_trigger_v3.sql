/*
  # Fix update_stock_on_purchase trigger (v3)

  1. Problem
    - inventory_movements.type check constraint only allows 'entrada' or 'salida'
    - Trigger was using 'purchase' which violates the constraint

  2. Fix
    - Use 'entrada' as the type for purchases (stock goes up = entrada)
*/
